...
const closeIt = document.querySelector(".my-close");
const showIt = document.querySelector(".menu-trigger--close");


closeIt.onclick = () => {
    const logo = document.querySelector(".logo");
const letsJam = document.querySelector(".menu-trigger");
    
    logo.classList.add("close");
    letsJam.classList.add("close");
}
...
const letsJam = document.querySelector(".menu-trigger");
    ...
    letsJam.classList.remove("close");
}
